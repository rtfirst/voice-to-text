...
def paste_text(text: str, target_hwnd=None):
    # Wait for physical keys to fully release
    time.sleep(0.3)

    # Restore focus to target window if provided
    if target_hwnd:
    ...
    # Detect window type and use appropriate paste method
